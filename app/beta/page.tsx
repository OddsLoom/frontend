    ...
    <SubpageShell>
      ...
      <section className="application-wrap">
        ...
        <form className="beta-form" onSubmit={submit}>
          ...
          <div className="form-row"><label>Preferred delivery<select name="delivery" required defaultValue=""><option value="" disabled>Select one</option><option>WebSocket</option><option>REST</option><option>WebSocket + REST</option><option>Not sure yet</option></select></label><label>Expected volume<select name="volume" required defaultValue=""><option value="" disabled>Select one</option><option>Exploring / unknown</option><option>Under 100K updates/day</option><option>100K–1M updates/day</option><option>1M–10M updates/day</option><option>10M+ updates/day</option></select></label></div>
          <div className="form-row"><label>Historical data<select name="historical" required defaultValue=""><option value="" disabled>Select one</option><option>Not needed</option><option>Helpful, not required</option><option>Required</option></select></label><label>Target integration<select name="timeline" required defaultValue=""><option value="" disabled>Select one</option><option>As soon as available</option><option>Within 3 months</option><option>Within 6 months</option><option>Researching only</option></select></label></div>
